...
class binSVM {
	...
	public:
		...
		//
		std::pair<std::string, double> getPairPredict(const std::vector<double>& _x);
		...
		//
		std::vector<size_t>& getNums();
		
		//
		std::vector<double>& getA();
		
		//
		void setNums(const std::vector<size_t>& i);
		
		//
		void setA(const std::vector<double>& i);
