...
class binSVM {
	...
	//
	std::tuple<std::vector<size_t>, std::vector<size_t>, std::vector<size_t>, std::vector<size_t>, std::vector<size_t>> get_candidates(const std::vector<double>& fx, bool flag, bool flag2);
