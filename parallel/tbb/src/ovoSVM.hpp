...
class ovoSVM {
	...
	public:
		...
		//
		std::vector<std::string> tbb_predict(const std::vector<std::vector<double>>& _x);
		//
		std::string balanced_predict(const std::vector<double>& _x); 
		
		//
		std::vector<std::string> balanced_predict(const std::vector<std::vector<double>>& _x);
		
		//
		std::vector<std::string> tbb_balanced_predict(const std::vector<std::vector<double>>& _x);
